...
%
% Prepares payload and speed interpolation knots, inverse knot spacings and
% phase-power matrices from the profile table for repeated evaluation by
% gpenmpcM600PreparedPhasePower.
