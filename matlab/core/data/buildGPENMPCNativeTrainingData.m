...
%
% Training and calibration matrices are constructed in MATLAB. The optional
% reference MAT is compared with the completed matrices for consistency.
...
parity = struct("reference_used", false, "status", "NOT_REQUESTED");
