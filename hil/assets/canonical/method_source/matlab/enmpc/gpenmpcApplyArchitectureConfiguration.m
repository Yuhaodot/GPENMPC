...
%GPENMPCAPPLYARCHITECTURECONFIGURATION Freeze A1 or A2 identity.
...
% Equivalence tolerances for normalized soft-ranking terms, separate from
% the hard-feasibility tolerance.
...
if any(config.coordinated_b1_radius_f_mps2 ...
    ...
    error("gpenmpcApplyArchitectureConfiguration:Radius", ...
        "Runtime B1 radius must not be smaller than the legacy predictor radius.");
end
