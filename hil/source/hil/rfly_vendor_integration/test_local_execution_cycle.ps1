...
$reader=Join-Path $vi 'local_source_ingress\Px4OriginalHilReceiptReader.cpp';$test=Join-Path $vi 'test_local_execution_cycle.cpp'
...
$receipt=[ordered]@{scope='ACTUAL_CYCLE_IO_READER_PHASE_C_PRIVATE74_GP_EXPLICIT_MOCK_BROKER_HRT_AUTHORITY';
