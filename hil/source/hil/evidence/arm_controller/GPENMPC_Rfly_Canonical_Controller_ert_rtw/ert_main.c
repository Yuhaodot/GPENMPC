...
#include "GPENMPC_Rfly_Canonical_Controller.h" /* Model header file */
...
void rt_OneStep(void)
{
  ...
  /* Check for overrun */
  if (OverrunFlag) {
    rtmSetErrorStatus(GPENMPC_Rfly_Canonical_Contro_M, "Overrun");
    return;
  }
...
int_T main(int_T argc, const char *argv[])
{
  ...
  fflush((NULL));
  while (rtmGetErrorStatus(GPENMPC_Rfly_Canonical_Contro_M) == (NULL)) {
