function report=test_rfly_disarmed_startup(outputRoot,initialLeg)
% Test disarmed phase-zero startup with one worker and C++ fixtures.
arguments
...
report=struct('status','PASS_DISARMED_STARTUP_ACTUAL_ASYNC_AND_GENERATED_C_FIXTURES', ...
    'checks',checks,'test_count',numel(checks),'pass_count',sum([checks.pass]), ...
    'actual_async_submissions',2,'actual_generated_c_steps',1,'actual_cpp_registration_fixture',true, ...
