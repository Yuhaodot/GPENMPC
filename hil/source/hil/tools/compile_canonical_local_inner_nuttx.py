#!/usr/bin/env python3
"""Compile the same generated 67 C TUs with real private FMUv6C flags.
...
root = Path(sys.argv[2]) if len(sys.argv) == 3 else Path(external_path('local_inner_codegen_source'))
...
for source in sources:
    ...
    if run.returncode:
        ...
        break
passed = len(records) == 67 and all(r['compiler_exit_code'] == 0 for r in records)
size_output = ''
undefined = ''
attributes = ''
...
if passed:
    ...
    archive = out / 'libcanonical_local_inner_m7.a'
