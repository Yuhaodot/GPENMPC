...
root=Path(external_path('canonical_local_inner_codegen'))
generated=root/'generated'
arm=Path(external_path('local_inner_arm_objects'))
label=sys.argv[1] if len(sys.argv)==2 else 'arm_stack'
assert re.fullmatch(r'arm_stack(?:_[a-z][a-z0-9_]*)?',label)
out=build/'evidence/local_state_store'/label
...
source=build/'rfly_vendor_integration/probe_canonical_local_state_store.cpp'
