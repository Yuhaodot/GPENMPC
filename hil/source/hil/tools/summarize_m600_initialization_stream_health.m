...
for name={'ATTITUDE','LOCAL_POSITION_NED','ESTIMATOR_STATUS'}
    ...
    if strcmp(topic,'ESTIMATOR_STATUS')
        ...
        s.freshness_basis='LOW_RATE_STATUS_STREAM__REPORT_ACTUAL_SOURCE_AND_RECEIVE_GAPS__NO_INVENTED_0_25_S_GATE';
...
report.interpretation={ ...
    ...
    'Any clock/model/source fault inside the observation remains latched. No new t0, segment joining, origin fit or reset laundering is performed.', ...
