...
out=struct('schema','HOST_POST_DISARM_STABILITY_ANALYSIS_V1','input',identity(input), ...
    ...
    'limitations',{{'No raw data removed or post-disarm rows reclassified as formal.', ...
        'Nearest source pairs are diagnostic with reported time differences; no truth is fed to controller/EKF.', ...
        'The examined 8 s window represents the proposed delivery dwell.', ...
        'No new physical ground detector, plant repair, restart, calibration or parameter action is performed.'}}, ...
