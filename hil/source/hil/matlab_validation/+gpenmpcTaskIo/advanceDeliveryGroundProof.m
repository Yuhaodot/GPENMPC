...
proof=struct('status',reason,'current_native_ground_disarmed_evidence_valid',good, ...
    ...
    'dwell_provenance','MU_CAMBRIDGE_MA_02_A1_CANONICAL_EIGHT_SECOND_GROUND_SERVICE', ...
...
assert(finiteScalar(p.service_dwell_s)&&p.service_dwell_s==8.0,'gpenmpcTaskIo:CanonicalServiceDwell','Service dwell must be 8 s.');
